      ...
      return [
        {
          id: `MOCK-${seed}-1`,
          asin: `MOCK-${seed}-1`,
            nome: `${normalizedQuery} na Amazon`,
          imagem: null,
            preco: null,
            disponibilidade: "Consulte preço e disponibilidade diretamente na Amazon",
          linkAfiliado: baseUrl,
        },
        {
          id: `MOCK-${seed}-2`,
          asin: `MOCK-${seed}-2`,
            nome: `Ofertas de ${normalizedQuery}`,
          imagem: null,
          preco: null,
            disponibilidade: "Consulte preço e disponibilidade diretamente na Amazon",
          linkAfiliado: baseUrl,
        },
        {
          id: `MOCK-${seed}-3`,
          asin: `MOCK-${seed}-3`,
            nome: `Comparar preços de ${normalizedQuery}`,
          imagem: null,
            preco: null,
            disponibilidade: "Consulte preço e disponibilidade diretamente na Amazon",
          linkAfiliado: baseUrl,
